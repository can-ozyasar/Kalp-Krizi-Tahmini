...
Kalp krizi riskini tahmin etmeye yönelik veri bilimi ve sınıflandırma çalışması.

## Bu Repo Ne İçin Var?
Sağlık verisiyle sınıflandırma modeli geliştirme ve risk tahmini sürecini incelemek için oluşturuldu.
...
- Sağlık verisiyle makine öğrenmesi
- Sınıflandırma modeli geliştirme
- Notebook üzerinden izlenebilir analiz
...
## Notebook İçeriği
- `KalpKriziTahmin.ipynb`

## Proje Yapısı
- `tables` - 4 dosya
- `KalpKriziTahmin.ipynb` - 1 dosya
- `heart.csv` - 1 dosya
- `o2Saturation.csv` - 1 dosya
...
- Notebook çalışmaları için kullanılan veri seti büyükse repoya eklemek yerine kaynağını veya indirme adımını belgeleyin.
